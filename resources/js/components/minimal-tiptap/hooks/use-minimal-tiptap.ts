...
import { TextAlign } from "@tiptap/extension-text-align"; // Ensure this import
import {
  Link,
  Image,
  HorizontalRule,
    ...
    onToggle(editor, files, pos) {
      editor.commands.insertContentAt(
        ...
        files.map((image) => {
          ...
          return {
            type: "image",
            attrs: { id, src: blobUrl, alt: image.name, title: image.name, fileName: image.name },
          };
        })
      );
    },
